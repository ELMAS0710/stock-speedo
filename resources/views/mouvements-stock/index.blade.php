                            ...
                            @foreach($mouvements as $mouvement)
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        ...
                                        @elseif($mouvement->type === 'transfert_entree')
                                            <span class="badge bg-info">
                                                <i class="fas fa-exchange-alt"></i> Transfert Entrée
                                            </span>
                                        @elseif($mouvement->type === 'transfert_sortie')
                                            <span class="badge bg-warning text-dark">
                                                <i class="fas fa-exchange-alt"></i> Transfert Sortie
                                            </span>
                                        @elseif($mouvement->type === 'ajustement')
                                            <span class="badge bg-secondary">
                                                <i class="fas fa-sliders-h"></i> Ajustement
                                            </span>
                                        @else
                                            <span class="badge bg-secondary">
                                                <i class="fas fa-question"></i> {{ $mouvement->type ?? 'Non défini' }}
                                            </span>
                                        @endif
                                    </td>
                                    <td class="align-middle">
                                    ...
                                    <td class="text-center align-middle">
                                        <span class="badge bg-primary fs-6">{{ number_format($mouvement->quantite, 2, ',', ' ') }}</span>
                                    </td>
                                    <td class="text-center align-middle">
