...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="bi bi-building-fill"></i> Modifier Depot</h2>
    ...
    <div class="col-md-10 offset-md-1">
        <div class="card shadow-sm">
            <div class="card-header bg-primary text-white">
                <h5 class="card-title mb-0"><i class="bi bi-pencil-square"></i> Informations du Depot</h5>
            </div>
            <div class="card-body p-4">
                <form action="{{ route('depots.update', $depot->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="responsable" 
                                   name="responsable" 
                                   value="{{ old('responsable', $depot->responsable) }}"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="telephone" 
                                   name="telephone" 
                                   value="{{ old('telephone', $depot->telephone) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control @error('adresse') is-invalid @enderror" 
                                  ...
                                  name="adresse" 
                                  rows="3"
                                  placeholder="Ex: 123 Rue de la Paix, 75001 Paris">{{ old('adresse', $depot->adresse) }}</textarea>
                        @error('adresse')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
