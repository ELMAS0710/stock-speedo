                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><strong><?php echo e($mouvement->article->nom); ?></strong></td>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><strong><?php echo e($mouvement->article->nom); ?></strong></td>
                                <td><?php echo e($mouvement->depot->nom); ?></td>
                                <td>
                                    <?php switch($mouvement->type_mouvement):
                                        ...
                                        <?php case ('sortie'): ?>
                                            ...
                                            <?php break; ?>
                                        <?php case ('transfert_sortie'): ?>
                                            <span class="badge bg-warning">Transfert Sortie</span>
                                            <?php break; ?>
                                        <?php case ('transfert_entree'): ?>
                                            <span class="badge bg-info">Transfert Entrée</span>
                                            <?php break; ?>
                                        <?php default: ?>
                                            <span class="badge bg-secondary"><?php echo e($mouvement->type_mouvement); ?></span>
                                    <?php endswitch; ?>
                                </td>
                                <td class="text-end"><?php echo e(number_format($mouvement->quantite, 0, ',', ' ')); ?></td>
                                <td><?php echo e($mouvement->createdBy->name ?? 'Système'); ?></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
    ...
    <div class="row g-4 mt-4">
        <div class="col-12">
            <div class="stat-card">
                ...
                <div class="row g-3">
                    <div class="col-md-3">
                        <a href="<?php echo e(route('mouvements-stock.create')); ?>" class="btn btn-primary w-100 py-3">
                            <i class="bi bi-plus-circle d-block mb-2" style="font-size: 2rem;"></i>
                            Nouveau mouvement de stock
                        </a>
                    </div>
                    <div class="col-md-3">
                        <a href="<?php echo e(route('devis.create')); ?>" class="btn btn-success w-100 py-3">
                            <i class="bi bi-file-earmark-plus d-block mb-2" style="font-size: 2rem;"></i>
                            Créer un devis
                        </a>
                    </div>
                    <div class="col-md-3">
                        <a href="<?php echo e(route('transferts.create')); ?>" class="btn btn-warning w-100 py-3">
                            <i class="bi bi-truck d-block mb-2" style="font-size: 2rem;"></i>
                            Nouveau transfert
                        </a>
                    </div>
                    <div class="col-md-3">
                        <a href="<?php echo e(route('stock.export-excel')); ?>" class="btn btn-info w-100 py-3">
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\GESTION STOCK\gestion_stock_speedo\resources\views/dashboard.blade.php ENDPATH**/ ?>